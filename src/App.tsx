...
function FinalMissionSection({ onComplete, addBossXp }: { onComplete: CompleteHandler; addBossXp: () => void }) {
  ...
  const bossQuestions: BossQuestion[] = [
    {
      prompt: 'A machine that simply follows fixed instructions without learning from data is called what?',
      options: ['A) Artificial Intelligence', 'B) Machine Learning', 'C) Automation', 'D) Data Science'],
      correct: 'C) Automation',
      explanation: 'Automation follows fixed rules or instructions. It does not learn patterns from data the way AI or machine learning systems do.',
    },
    {
      prompt: 'Which AI domain allows self-driving cars to recognize pedestrians and traffic signals?',
      options: ['A) Computer Vision', 'B) Natural Language Processing', 'C) Data Science', 'D) Regression'],
      correct: 'A) Computer Vision',
      explanation: 'Computer Vision helps AI systems understand images and video, including pedestrians, vehicles, signs, and traffic signals.',
    },
    {
      prompt: 'If an AI is reading a movie review to figure out if the customer is happy or angry, what specific technology is it using?',
      options: ['A) Object Tracking', 'B) Sentiment Analysis', 'C) Image Acquisition', 'D) Clustering'],
      correct: 'B) Sentiment Analysis',
      explanation: 'Sentiment Analysis is a Natural Language Processing task that identifies whether text expresses a positive, neutral, or negative feeling.',
    },
    {
      prompt: 'Your AI needs to predict the exact price of a house based on its size and location. Which technique should it use?',
      options: ['A) Classification', 'B) Clustering', 'C) Regression', 'D) Tokenization'],
      correct: 'C) Regression',
      explanation: 'Regression predicts a number, such as a price, score, temperature, or sales amount.',
    },
    {
      prompt: 'You give an AI a massive pile of messy, unlabeled data and ask it to organize it based on similarities. What is this called?',
      options: ['A) Classification', 'B) Supervised Learning', 'C) Clustering', 'D) Syntax Analysis'],
      correct: 'C) Clustering',
      explanation: 'Clustering is an unsupervised learning method that groups similar data points without needing labels first.',
    },
    {
      prompt: 'Which part of a dataset is used as the "final exam" to verify if the AI actually learned correctly?',
      options: ['A) The Training Dataset', 'B) The Validation Dataset', 'C) The Test Dataset', 'D) The Raw Dataset'],
      correct: 'C) The Test Dataset',
      explanation: 'The test dataset is held back until the end so it can check how well the model performs on examples it has not practiced on.',
    },
    {
      prompt: 'In Computer Vision, what is the step called where the AI cleans up the image to reduce noise and correct brightness?',
      options: ['A) Feature Extraction', 'B) Object Categorization', 'C) Image Acquisition', 'D) Pre-processing'],
      correct: 'D) Pre-processing',
      explanation: 'Pre-processing prepares images before analysis by improving quality, reducing noise, and normalizing brightness or contrast.',
    },
    {
      prompt: 'Which AI domain acts as the "brain," looking for patterns in organized numbers and text to spot credit card fraud?',
      options: ['A) Computer Vision', 'B) Natural Language Processing', 'C) Data Science', 'D) Automation'],
      correct: 'C) Data Science',
      explanation: 'Data Science uses organized data, statistics, and models to find patterns, make predictions, and detect unusual behavior like fraud.',
    },
    {
      prompt: 'A dataset that is perfectly organized into rows and columns, making it easy to search, is called what?',
      options: ['A) Unstructured Dataset', 'B) Spatial Dataset', 'C) Structured Dataset', 'D) Multimedia Dataset'],
      correct: 'C) Structured Dataset',
      explanation: 'A structured dataset is arranged in a clear format, often rows and columns, so it is easier to query and analyze.',
    },
    {
      prompt: 'When an AI makes a mistake, data scientists give it fresh data to tweak the model and improve its accuracy. What is this process called?',
      options: ['A) Feedback Loops', 'B) Tokenization', 'C) Feature Extraction', 'D) Object Tracking'],
      correct: 'A) Feedback Loops',
      explanation: 'Feedback loops use new results and corrections to improve the model over time.',
    },
  ];
